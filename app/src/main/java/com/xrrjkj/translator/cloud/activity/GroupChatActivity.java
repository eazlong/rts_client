...
import com.xrrjkj.translator.cloud.MainActivity;
 ...
 */
public class GroupChatActivity extends BaseFragmentActivity implements ProcessSpeexRunnable.ProcessSpeexListener , RTMPRunnable.RTMPListener{
    ...
    protected void setContentView() {
        setWindowStatusBarColor(this, R.color.bg_navy);
    ...
    protected void findViews() {
        ...
        llyt_language.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GroupChatActivity.this, LanguageListActivity.class);
...
//        list.add(chatInfo2);
        ...
        if(list!=null && list.size()>0){
            mAdapter = new GroupChatListAdapter(list, GroupChatActivity.this);
...
//        start();
    ...
    private void anim(){
        iv_mic.startAnimation(AnimationUtils.loadAnimation(
                GroupChatActivity.this, R.anim.fab_anim));
    }
}
